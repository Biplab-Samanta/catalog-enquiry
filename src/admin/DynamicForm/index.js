...
export default class DynamicForm extends React.Component {
	...
	ontableChange(e, target, status) {
		const tables_value = this.state.complete_option_value ? this.state.complete_option_value : [];
		tables_value[status] = status.includes("_checkbox") ? e.target.checked : e.target.value;
	...
	handleOnChangedada(mtarget, e, target) {
		const tables_value = this.state.complete_own_details ? this.state.complete_own_details : [];
		var test_data = '';
		if (target === 'btn_size') {
						...
						<tr className="mvx-settings-tr-wrap">
							...
							<td className="mvx-settings-td-wrap">
								<div className="mvx-toggle-checkbox-content">
									<input
										...
										key={o.id}
										name={o.id}
										checked={table_content_load ? table_content_load[`${o.id}_checkbox`]: false}
										onChange={(e) => {
											this.ontableChange(
												e,
												m.key,
							...
							<td className="mvx-settings-td-wrap">
								<input
									...
									key={o.id}
									id={o.id}
									value={table_content_load ? table_content_load[o.id] : ''}
									onChange={(e) => {
			...
			if (type === 'own_button') {
				...
				input = (
					...
					<Box sx={{ minWidth: 120 }}>
						...
						<Slider defaultValue={60} aria-label="Default" valueLabelDisplay="auto" onChange={(e) => {
								this.handleOnChangedada(target, e, 'btn_size');
							}} />
						<Typography gutterBottom>Font Size:</Typography>
						<Slider defaultValue={60} aria-label="Default" valueLabelDisplay="auto" onChange={(e) => {
								this.handleOnChangedada(target, e, 'font_size');
							}} />
						<Typography gutterBottom>Border Radius:</Typography>
						<Slider defaultValue={60} aria-label="Default" valueLabelDisplay="auto" onChange={(e) => {
								this.handleOnChangedada(target, e, 'border_radious');
							}} />
						<Typography gutterBottom>Border Size:</Typography>
						<Slider defaultValue={60} aria-label="Default" valueLabelDisplay="auto" onChange={(e) => {
								this.handleOnChangedada(target, e, 'border_size');
							}} />
							</div>
						...
						<input
							...
							type="color"
							onChange={(e) => {
								this.handleOnChangedada(target, e, 'top_gradient_color');
							}}
							
						/>
						</div>
						<div className="mvx-color-picker-wrap">
						<Typography>Bottom Gradient Color</Typography>
						<input
							{...props}
							className="mvx-setting-color-picker"
							type="color"
							onChange={(e) => {
								this.handleOnChangedada(target, e, 'bottom_gradient_color');
							}}
						...
						<input
							...
							type="color"
							onChange={(e) => {
								this.handleOnChangedada(target, e, 'border_color');
							}}
							
						/>
						</div>
						<div className="mvx-color-picker-wrap">
						<Typography>Hover Background Color</Typography>
						<input
							{...props}
							className="mvx-setting-color-picker"
							type="color"
							onChange={(e) => {
								this.handleOnChangedada(target, e, 'hover_background_color');
							}}
						...
						<input
							...
							type="color"
							onChange={(e) => {
								this.handleOnChangedada(target, e, 'text_color');
							}}
						...
						<input
							...
							type="color"
							onChange={(e) => {
								this.handleOnChangedada(target, e, 'hover_text_color');
							}}
							
						/>
						</div>
						<div className="mvx-color-picker-wrap">
						<Typography>Active Background Color</Typography>
						<input
							{...props}
							className="mvx-setting-color-picker"
							type="color"
							onChange={(e) => {
								this.handleOnChangedada(target, e, 'active_background_color');
							}}
					...
					<div className="mvx-color-picker-wrap">
				        ...
				        <Selecty
				          ...
				          label="Select Font"
				          onChange={(e) => {
								this.handleOnChangedada(target, e, 'onmselect');
							}}
				        >
				          <MenuItem value="Helvetica, Arial, Sans-Serif">Helvetica</MenuItem>
				          <MenuItem value="Georgia, Serif">Georgia</MenuItem>
				          <MenuItem value="Lucida Grande, Helvetica, Arial, Sans-Serif">Lucida Grande</MenuItem>
				        </Selecty>
						</div>
						</div>
				</Box>
				<Box>
						...
						<div onMouseEnter={this.handleOMouseEnter} onMouseLeave={this.handleOMouseLeave} style={
							{color: this.state.hover_on && ownbutton_content_load ? ownbutton_content_load['hover_text_color'] : ownbutton_content_load['text_color'], 
							fontFamily: ownbutton_content_load['onmselect'], 
							fontSize: ownbutton_content_load['font_size'], 
							padding: ownbutton_content_load['btn_size'], 
							borderRadius: ownbutton_content_load['border_radious'], 
							border: `${ownbutton_content_load['border_size']} solid ${ownbutton_content_load['border_color']}` , 
							background: ownbutton_content_load['hover_on'] ? ownbutton_content_load['hover_background_color'] : ownbutton_content_load['bottom_gradient_color'], 
