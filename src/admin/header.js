        ...
        // preview button click function ------
            $(".p-prev").click(function(){  
                ...
                if ($(".mvx-logo-top .mvx-pro-txt:visible").prev().length != 0){
                    ...
                    $('.mvx-pro-txt').css("animation", ".5s slide-right");
        ...
        // next button click function ------
            $(".p-next").click(function(){              
                ...
                if ($(".mvx-logo-top .mvx-pro-txt:visible").next().length != 0){
                    ...
                    $('.mvx-pro-txt').css("animation", ".5s slide-left");
                    }
                ...
                <div className='mvx-banner-top'>
                    <div className='mvx-logo-top'>
                        ...
                        <div className='mvx-pro-txt-items'>
                            <h3>Upgrade to WooCommerce Quote and Product Enquiry </h3>
                        ...
                        <div className='mvx-pro-txt-items'>
                            ...
                            <p>Send enquiries about different products from different vendors to the same enquiry cart with mini cart option. </p>
                            <a href='#' className="mvx-btn btn-red">
                                 Go to pro
                            </a>
                        </div>
