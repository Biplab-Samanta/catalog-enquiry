	...
	function mvx_catalog_admin_tabs() {
		...
		$catalog_settings_page_endpoint = apply_filters('mvx_catalog_endpoint_fields_before_value', array(
			'general' => array(
				...
				'modulename'      =>  [
					...
					[
						...
						'desc'      => __( 'Select page where user will be redirected for disable cart page. To use this feature kindly upgrade to <a href="https://multivendorx.com/product/woocommerce-catalog-enquiry-pro/" target="_blank">WooCommerce Catalog Enquiry Pro</a>.', 'woocommerce-catalog-enquiry' ),
						'options' => $pages_array,
						'database_value' => '',
					],
					[
			...
			'enquiry-form'  =>  array(
				...
				'modulename'    =>  [
		            ...
		            [
	                    ...
	                    'desc'      => __('Want to customise the form as per your need? To have a fully customizable form kindly upgrade to <a href="https://multivendorx.com/product/woocommerce-catalog-enquiry-pro/" target="_blank">WooCommerce Catalog Enquiry Pro</a>', 'woocommerce-catalog-enquiry', 'woocommerce-catalog-enquiry'),
	                    'label_options' =>  array(
			...
			'live-preview'  =>  array(
					...
					'link'          =>  'https://multivendorx.com/product/woocommerce-catalog-enquiry-pro/',
			),
			'upgrade' =>  array(
